...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-inferno/node_modules/inferno/dist/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-inferno/node_modules/inferno/dist/index.js</span></h1>
    <h2>
        
        Statements: <span class="metric">96.77% <small>(30 / 31)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-inferno/node_modules/inferno/dist/</a> &#187; index.js</div>
</div>
<div class="body">
...
<span class="missing-if-branch" title="else path not taken" >E</span>if (process.env.NODE_ENV !== 'production') {
    ...
    var testFunc = <span class="fstat-no" title="function not covered" >function testFn() {</span> };
    <span class="missing-if-branch" title="if path not taken" >I</span>if ((testFunc.name || <span class="branch-1 cbranch-no" title="branch not covered" >testFunc.toString())</span>.indexOf('testFn') === -1) {
<span class="cstat-no" title="statement not covered" >        inferno_shared_1.warning(('It looks like you\'re using a minified copy of the development build ' +</span>
